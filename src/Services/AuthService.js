    ...
    try {
        ...
        const eventPayload = {
            ...
            data: {
                ...
                document: user === null || user === void 0 ? void 0 : user.dni,
                address: (user === null || user === void 0 ? void 0 : user.address) ? user === null || user === void 0 ? void 0 : user.address : "",
...
exports.RecoverPassword = (email) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        if (user === null || user === void 0 ? void 0 : user.isEmployee) {
            const eventPayload = {
                sender: "usuarios",
                created_at: Date.now(),
